  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-6 py-14 gs-canvas">
      <div className="w-full max-w-md">
        ...
        <p className="text-[color:var(--ink-3)] text-sm mt-2">Pick your role — we'll tailor the workspace to fit.</p>
        <form onSubmit={submit} data-testid="register-form" className="mt-8 space-y-4">
          ...
          <div>
            <label className="text-xs font-mono text-[color:var(--ink-3)]">YOUR ROLE</label>
                ...
                <button
                  ...
                  className={`text-left rounded-xl p-3 border transition ${
                    form.role === r.value
                      ...
                      : "border-[color:var(--line)] hover:border-[color:var(--brand)] bg-white"
                  }`}
                >
